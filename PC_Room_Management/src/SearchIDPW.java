...
public class SearchIDPW {
	public SearchIDPW() {
		JButton okbtn = new JButton(new ImageIcon("image/ok_graybtn.png"));
		JButton backbtn = new JButton(new ImageIcon("image/back_graybtn.png"));
